...
//
//	mockgen -source=transaction_manager.go -destination=mocks/transaction_manager_mock.go -package=mocks
//
...
import (
	...
	repositories "github.com/AndrivA89/orders/internal/domain/repositories"
...
func (m *MockTransactionManager) WithTransaction(ctx context.Context, fn func(context.Context, repositories.TransactionalRepositories) error) error {
	m.ctrl.T.Helper()
